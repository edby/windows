//+------------------------------------------------------------------+
//|                                                                  |
//|           It is Ok for UDSJPY on M15 Chart for 5 years profit    |
//|                                                                  |
//+------------------------------------------------------------------+
...
int start()
{
  ...
  for(int i = Limit; i >= 0; i--)
  {
    ...
    PT_Buffer_1[i] = iMA(NULL, 0, P_Point_1/Time_Frame, 0, MODE_SMA, (PRICE_HIGH+PRICE_LOW+PRICE_CLOSE+PRICE_OPEN)/4, i);
  }

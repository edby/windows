//+------------------------------------------------------------------+  
//|                                                                  | 
//|              Modify int start()                                  |  // let added orders run just as original order, once one order
//|                                                                  |  // was closed by reserse signal, close all.
//+------------------------------------------------------------------+  
#include <stdlib.mqh>
  extern int 
      Magic_Number_N  = 1
    ...
    else if( OrderSelect(OrdersTotal()-1,SELECT_BY_POS) )
    {
      ...
      { 
        ...
        { 
          ...
          {
            if(OrderSelect(0,SELECT_BY_POS)) double OP = OrderOpenPrice();
            else                                    OP = 0.0;
            //if(OP < Stop_Loss && OP > 0.0)
      ...
      else if( OrderType() == OP_SELL) 
      {
        ...
        { 
          ...
          {
            if(OrderSelect(0,SELECT_BY_POS))        OP = OrderOpenPrice();
            else                                    OP = 0.0;
            //if( OP > Stop_Loss )

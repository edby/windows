...
#property  indicator_color2  Yellow
  ...
  {     
    ...
    IndicatorShortName("Swing_Rate(Seek_Period_1("+Seek_Period_1+") and Range_Ratio("+Range_Ratio+"))");
    IndicatorBuffers      (2);

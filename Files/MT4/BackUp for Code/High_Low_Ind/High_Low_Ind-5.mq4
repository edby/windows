...
{  
   ...
   for(int i=Limit;i>=0;i--)
   {
     ...
     {
       int x=iHighest(NULL,0,MODE_HIGH,P_CNT,i); if(x-i<Seek_Period/3) break;
       ...
       if(High_Refer_0==High[x]&&High_Refer_0-Low_Refer_0>=Mini_Swing*Point_Adapted/2) //peak confirm
       {
         ...
         if(i==0&&High_Refer_0-Close[0]<7*Point_Adapted&&High_Refer_0-Low_Refer_0>=Mini_Swing*Point_Adapted&& //H_Current_0>High[0]&& 
         H_Current_0>=High_Refer_0-Trade_Range*Point_Adapted&&H_Current_0<=High_Refer_0+Trade_Range*Point_Adapted //touch trading ranges
     ...
     while(P_CNT>=Seek_Period/2)
     {
       int y=iLowest(NULL,0,MODE_LOW,P_CNT,i); if(y-i<Seek_Period/3) break;
       ...
       if(Low_Refer_1==Low[y]&&High_Refer_1-Low_Refer_1>=Mini_Swing*Point_Adapted/2) //lawn confirm
       {
         ...
         if(i==0&&Close[0]-Low_Refer_1<7*Point_Adapted&&High_Refer_1-Low_Refer_1>=Mini_Swing*Point_Adapted&& //L_Current_1<Low[0]&&
         L_Current_1<=Low_Refer_1+Trade_Range*Point_Adapted&&L_Current_1>=Low_Refer_1-Trade_Range*Point_Adapted  //touch trading ranges

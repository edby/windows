...
{  
   ...
   for(int i=Limit;i>=0;i--)
   {
     ...
     while(P_CNT>=Seek_Period/2)
     {
       int x=iHighest(NULL,0,MODE_HIGH,P_CNT,i); if(x-i<Seek_Period/4) break;
       ...
       if(High_Refer_0==High[x]&&High_Refer_0-Low_Refer_0>=Mini_Swing*Point_Adapted) //peak confirm
       {
         ...
         if(i==0&&Low[0]!=Low_Refer_0&&High_Refer_0-Close[0]<7*Point_Adapted&&  //H_Current_0!=High[0]&&
     ...
     while(P_CNT>=Seek_Period/2)
     {
       int y=iLowest(NULL,0,MODE_LOW,P_CNT,i); if(y-i<Seek_Period/2) break;
       ...
       if(Low_Refer_1==Low[y]&&High_Refer_1-Low_Refer_1>=Mini_Swing*Point_Adapted) //lawn confirm
       {
         ...
         if(i==0&&High[0]!=High_Refer_1&&Close[0]-Low_Refer_1<7*Point_Adapted&& //L_Current_1!=Low[0]&&

...
extern int Seek_Period=15,Mini_Swing=8,Trade_Range=9; //Mini_Swing_Left and Mini_Swing_Right;
...
{  
   ...
   for(int i=Limit-1;i>0;i--)
   {
     ...
     while(P_CNT>=6)
     {
       ...
       H_Current_0=High[iHighest(NULL,0,MODE_HIGH,3,0)],L_Current_0=Low[iLowest(NULL,0,MODE_LOW,2,1)];
       if(High_Refer_0==High[x]&&High_Refer_0-Low_Refer_0>=Mini_Swing*Point_Adapted) //peak confirm
       {
         ...
         if(
            ...
            &&H_Current_0!=High[0]&&Close[0]<L_Current_0    //triger trading
           ){Call[0]=-1;break;}
       }
       P_CNT--;        
     }
     ...
     while(P_CNT>=6)
     {
       ...
       double Low_Refer_1=Low[iLowest(NULL,0,MODE_LOW,10,y-5)],High_Refer_1=High[iHighest(NULL,0,MODE_HIGH,y,0)],
       L_Current_1=Low[iLowest(NULL,0,MODE_LOW,3,0)],H_Current_1=High[iHighest(NULL,0,MODE_HIGH,2,1)];
       if(Low_Refer_1==Low[y]&&High_Refer_1-Low_Refer_1>=Mini_Swing*Point_Adapted) //lawn confirm
       {
         ...
         if(
            ...
            &&L_Current_1!=Low[0]&&Close[0]>H_Current_1    //triger trading
           ){Call[0]=1;break;}
       }
       P_CNT--;    
     }

//+------------------------------------------------------------------+
//|         1. Modify loop for() i=limit;i>=0;i--                    |
//|         2. In loop for(), some 0s have been changed to i         |
//|         3. changed conditions of triger trading                  |
//+------------------------------------------------------------------+
...
{  
   ...
   for(int i=Limit;i>=0;i--)
   {
     ...
     while(P_CNT>=6)
     {
       ...
       double High_Refer_0=High[iHighest(NULL,0,MODE_HIGH,10,x-5)],Low_Refer_0=Low[iLowest(NULL,0,MODE_LOW,x,i)],
       ...
       if(High_Refer_0==High[x]&&High_Refer_0-Low_Refer_0>=Mini_Swing*Point_Adapted) //peak confirm
       {
         ...
         if(i==0&&
            H_Current_0!=High[0]&&H_Current_0>=High_Refer_0-Trade_Range*Point_Adapted/2&&H_Current_0<=High_Refer_0+Trade_Range*Point_Adapted //touch trading ranges
     ...
     while(P_CNT>=6)
     {
       int y=iLowest(NULL,0,MODE_LOW,P_CNT,i); if(y<5) break;
       double Low_Refer_1=Low[iLowest(NULL,0,MODE_LOW,10,y-5)],High_Refer_1=High[iHighest(NULL,0,MODE_HIGH,y,i)],
       ...
       if(Low_Refer_1==Low[y]&&High_Refer_1-Low_Refer_1>=Mini_Swing*Point_Adapted) //lawn confirm
       {
         ...
         if(i==0&&
            L_Current_1!=Low[0]&&L_Current_1<=Low_Refer_1+Trade_Range*Point_Adapted/2&&L_Current_1>=Low_Refer_1-Trade_Range*Point_Adapted  //touch trading ranges

...
/*                                                                                                
  if(((ObjectGet(DoubleToStr(j,0),OBJPROP_COLOR)==White&&ObjectGet(DoubleToStr(j,0),OBJPROP_TIME1)==Time[Bar_Number])||
      (ObjectGet(DoubleToStr(j-1,0),OBJPROP_COLOR)==White&&ObjectGet(DoubleToStr(j-1,0),OBJPROP_TIME1)==Time[Bar_Number]))&&
      Text_Or_Line==0);            //  delete " ObjectGet(DoubleToStr(j,0),OBJPROP_TIME1)!=ObjectGet(DoubleToStr(j-1,0),OBJPROP_TIME1)&&"
*/
